  ...
  return (
    <footer className="bg-[#0F1D2F]">
      <div className="border-b border-white/10 px-6 py-16 md:px-12 md:py-20 text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Ready to see your selling options?</h2>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 max-w-5xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="mailto:godutchhomebuyers@gmail.com" className="flex items-center gap-2 text-sm text-white/50 hover:text-white transition-colors"><Mail className="h-4 w-4" />godutchhomebuyers@gmail.com</a></li>
